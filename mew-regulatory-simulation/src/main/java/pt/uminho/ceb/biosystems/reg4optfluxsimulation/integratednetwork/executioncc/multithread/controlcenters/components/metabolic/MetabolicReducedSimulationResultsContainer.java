...
public class MetabolicReducedSimulationResultsContainer extends AbstractSimulationResultsContainer<ReducedGeneSteadyStateSimulationResult> {

	public MetabolicReducedSimulationResultsContainer(ReducedGeneSteadyStateSimulationResult results, String knockoutedgeneid,
			String environmentalconditionid) {

...
public class MultipleExtendedIntegratedSimulationResultsContainer extends AbstractMultipleSimulationResultsContainer<IntegratedSimulationResultsContainer>{



	public MultipleExtendedIntegratedSimulationResultsContainer() {
		super();
	}
	...
	public void appendResult(String environmentalconditionid,String knockoutedgeneid, IntegratedSimulationMethodResult simulationresults){
		appendResult(environmentalconditionid, knockoutedgeneid, new IntegratedSimulationResultsContainer(simulationresults, knockoutedgeneid, environmentalconditionid));
	}
...
/*
	public void appendResults(ListIntegratedReducedSolutions listintegratedsols){
		...
		for (int i = 0; i < listintegratedsols.size(); i++) {
			IntegratedSimulationResultsContainer container=listintegratedsols.get(i);

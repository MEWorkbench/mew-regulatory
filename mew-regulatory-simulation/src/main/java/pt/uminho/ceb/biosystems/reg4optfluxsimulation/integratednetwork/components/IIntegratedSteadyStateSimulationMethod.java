...
public interface IIntegratedSteadyStateSimulationMethod extends ISteadyStateSimulationMethod{
	
	boolean checkIfMandatoryPropertiesSatisfied(Map<String, Object> properties);

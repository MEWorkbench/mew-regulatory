...
public class IntegratedSimulationResultsContainer extends AbstractSimulationResultsContainer<IntegratedSimulationMethodResult> {

	
	
	
	
	public IntegratedSimulationResultsContainer(IntegratedSimulationMethodResult results, String knockoutedgeneid,String environmentalconditionid) {

...
public class AsynchronousSimulationResults extends SynchronousSimulationResults{
	...
	public AsynchronousSimulationResults(IRegulatoryNetwork model, InitialRegulatoryState initialregulatorystate,
	...
	public RegulatoryResultsContainerType getTypeOfResults() {
		return RegulatoryResultsContainerType.AsynchronousSimulationResults;
	}

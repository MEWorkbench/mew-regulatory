...
public class UnsuportedVariableMappingOperationException extends UnsuportedVariableException{
	...
	public UnsuportedVariableMappingOperationException(String message){
		super(message);
	}
